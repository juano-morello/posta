...
#### T6.1.1 · `feat: emit dark theme CSS custom properties from _tokens.scss`
...
#### T6.1.2 · `feat: add the light theme map behind the .light class`
...
#### T6.1.3 · `feat: emit the no-humano gray ramp per theme`
...
#### T6.1.4 · `feat: alias shadcn token names onto the Posta token set`
...
#### T6.1.7 · `test: assert Tailwind and _tokens.scss never drift apart`
...
#### T6.1.8 · `feat: self-host Space Grotesk and JetBrains Mono as woff2 subsets`
...
#### T6.1.9 · `feat: preload both fonts in the root layout`
...
#### T6.1.10 · `test: forbid runtime Google Fonts requests`
...
#### T6.1.11 · `feat: add an SSR-safe ThemeProvider with a .light class toggle`
...
#### T6.1.12 · `feat: persist the theme and block the flash with a pre-hydration script`
...
#### T6.1.13 · `test: grep test forbidding hex literals in component files`
...
#### T6.1.14 · `test: assert AA contrast for text pairs in both themes` [a11y]
...
#### T6.2.1 · `chore: init shadcn/ui against the Posta tokens`
...
#### T6.2.2 · `feat: add the shadcn form primitives`
...
#### T6.2.3 · `feat: add the shadcn overlay primitives`
...
#### T6.2.4 · `feat: add the shadcn feedback primitives`
...
#### T6.2.5 · `feat: implement the five Button variants with hover, disabled and loading`
...
#### T6.2.6 · `feat: add Input focus halo and error treatment`
...
#### T6.2.7 · `feat: add the borders-over-shadows Card primitive`
...
#### T6.2.8 · `feat: reserve elevation shadows for real overlays`
...
#### T6.2.9 · `feat: add the mono toast variant`
...
#### T6.2.10 · `test: snapshot every primitive in dark and light`
...
#### T6.3.1 · `feat: add the 220px Sidebar with the v1 route list`
...
#### T6.3.2 · `feat: mark the active sidebar item with indicator, tint and lime text`
...
#### T6.3.3 · `feat: add the Topbar with ⌘K, avatar and Nuevo link`
...
#### T6.3.4 · `feat: add BottomTabs with the four v1 tabs`
...
#### T6.3.5 · `feat: respect safe-area inset and 44px hit targets on the bottom bar` [a11y]
...
#### T6.3.6 · `feat: swap Sidebar for BottomTabs at the 800px breakpoint`
...
#### T6.3.7 · `feat: add the auto-fit card grid utility`
...
#### T6.3.8 · `feat: add clamp() page padding and hero numeral scales`
...
#### T6.3.9 · `test: keyboard traversal and visible focus ring across the shell` [a11y]
...
#### T6.3.10 · `test: assert one lime focus per view`
...
#### T6.4.1 · `feat: add the classification vocabulary to contracts`
...
#### T6.4.2 · `feat: add the classification colour map`
...
#### T6.4.5 · `feat: keep sub-1% HumanoBar segments visible`
...
#### T6.4.6 · `feat: add the HumanoBar legend with labels and counts` [a11y]
...
#### T6.4.7 · `feat: add BadgeHumano with an interpolated color-mix tint`
...
#### T6.4.8 · `feat: add SourceChip with a coloured dot per platform`
...
#### T6.4.9 · `feat: SourceChip falls back to directo for unknown platforms`
...
#### T6.4.10 · `feat: add the Recibos dark island shell`
...
#### T6.4.11 · `feat: render Recibos rows as time · source · [classification] · why`
...
#### T6.4.12 · `perf: cap the Recibos row buffer`
...
#### T6.4.13 · `feat: harden the Recibos why string against hostile user-agents` [security]
...
#### T6.4.14 · `feat: add the Recibos empty state in terminal voice`
...
#### T6.4.15 · `test: a11y pass over the four honesty primitives` [a11y]
...
#### T6.5.1 · `feat: add the /gallery route with a section layout`
...
#### T6.5.2 · `feat: add the gallery fixtures module`
...
#### T6.5.3 · `feat: add gallery entries for the shadcn primitives`
...
#### T6.5.4 · `feat: add gallery entries for the four honesty primitives`
...
#### T6.5.5 · `feat: add gallery entries for the shell at both breakpoints`
...
#### T6.5.6 · `feat: add honesty edge-case fixtures to the gallery`
...
#### T6.5.7 · `feat: add the theme toggle to the gallery`
...
#### T6.5.8 · `test: add gallery visual regression snapshots`
...
#### T6.5.9 · `ci: run the visual regression suite and upload diffs`
