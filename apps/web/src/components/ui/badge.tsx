...
// — arbitrary-value Tailwind classes (`bg-[color-mix(...)]`) pass their
// contents straight through untouched, so no SCSS/PostCSS layer ever gets
// a chance to try (and fail) to evaluate the function itself.
